...
«Возрождение» — это пространство, где ты возвращаешься к себе. Пространство, где начинается твоя новая жизнь.`
  },
  {
    icon: Eye,
    title: "Мой подход",
  ...
  },
  {
    ...
    content: `Ретрит «Возрождение» родился как отражение моего пути. Я знаю, каково это — терять себя, искать смысл, проходить через кризисы и панические атаки, заново собирая свою душу по частям.

И я знаю, как выглядит момент, когда человек говорит: «Я вернулся к себе. Я живу. Я люблю. Я чувствую смысл».

Именно для этого я создаю свои программы.`
  },
  {
    icon: Gem,
