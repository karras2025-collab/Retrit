        ...
        <footer id="footer" className="bg-stone-900 text-stone-300">
            ...
            <div className="bg-primary-800 py-5 sm:py-6">
                <div className="container mx-auto px-4 text-center">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-serif text-white mb-2 sm:mb-3">
                        Остались вопросы?
                    </h3>
                    <p className="text-sm sm:text-base md:text-lg text-primary-100 mb-4 sm:mb-5 max-w-2xl mx-auto px-2">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 sm:gap-3 bg-primary-800 hover:bg-primary-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center justify-center gap-2 sm:gap-3 bg-sky-500 hover:bg-sky-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-base sm:text-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg"
                        >
                            <Send size={24} />
                            Telegram
                        </a>
